...
public class Arreglos {
    ...
    /**
     *Suma todos los elemento del arreglo
     *@param arr el arreglo de donde se sumaran los numeros
    ...
    public static void main(String[] args) {
       ...
       int[] lista = {1,4,6,10,40};
             int resultado = suma(lista);
              System.out.println("El inciso 5 está bien"); // Tus pruebas
